...
int main(){
    ...
    int unidad = 0, total;     //Declaro las variables de unidad y total a pagar como enteras.
    float precio = 0.25;       //Declaro la variable del precio como una de tipo flotante.
